...
<head>
  ...
  <style>
    * { box-sizing:border-box; }
    ...
    .pin-digit { width:32px; height:4px; border-radius:999px; background:#ffba08; transition:height .15s ease, transform .15s ease; }
    .pin-digit.is-filled { height:10px; transform:translateY(-3px); }
    ...
    (function () {
      ...
      function sync() {
        ...
        indicators.forEach(function (indicator, index) {
          indicator.classList.toggle('is-filled', index < value.length);
        });
