...
<div class="franchise-card">
  <form class="franchise-form" action="#" method="post">
    @csrf
    <div class="form-field">
      <label class="form-label" for="fullname">Fullname</label>
      <input class="form-control" id="fullname" name="fullname" type="text" placeholder="Enter your name">
    </div>
    ...
    <div class="form-field full">
      ...
      <textarea class="form-message" id="message" name="message" placeholder="Leave your message here"></textarea>
    </div>
